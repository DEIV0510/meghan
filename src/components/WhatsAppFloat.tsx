...
export function WhatsAppFloat() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-champagne text-ink shadow-[0_8px_30px_rgba(0,0,0,0.4)] sm:bottom-8 sm:right-8"
    >
